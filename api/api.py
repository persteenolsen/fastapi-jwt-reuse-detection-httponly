...
app = FastAPI(
    ...
    description="12-07-2026 - FastAPI serving Authentication by JWT with Refresh Token Rotation and Revoked Token Reuse Detection and HttpOnly secure cookie using these credentials: testuser / admin",
    version="0.0.2",
    contact={
        "name": "Per Olsen",
